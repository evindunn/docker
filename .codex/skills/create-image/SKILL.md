...
5. Make sure the `paths` filters include the workflow file, the shared README check script, the build context, [../../../README.md](../../../README.md), and shared assets under [../../../shared](../../../shared).
...
- Generated workflows match the current `debian-trixie-slim` pattern, including separate `IMAGE` and `TAG` outputs, `docker/setup-buildx-action`, and a shared auxiliary build context at `./shared`.
